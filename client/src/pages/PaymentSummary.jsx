...
export default function PaymentSummary() {
  ...
  const createTicket = async (e) => {
    ...
    try {
      ...
      window.toastify("Ticket Created", 'success');
      setRedirect(true)
      window.toastify('Success creating ticket', 'success')
    } catch (error) {
      window.toastify('Error creating ticket:', 'error');
    }
  ...
  async function generateQRCode(name, eventName) {
    try {
      ...
      window.toastify("Error generating QR code:", error);
      return null;
    }
  }
  if (redirect) {
